...
public class Renderer {
     ...
     */
    public Renderer(GoogleMap map, Activity activity, MarkerManager markerManager, PolygonManager polygonManager, PolylineManager polylineManager, GroundOverlayManager groundOverlayManager) {
        mMap = map;
        mActivity = activity;
        mLayerOnMap = false;
